...
const {authLimiter}=require("../ratelimiters/ratelimiter");
...
router.route('/guest-login').post(authLimiter,authController.guestSignup);
...
router.route('/updatePassword').post(authLimiter,authController.protect,authController.updatePassword)
